    ...
    <div className="header">
      ...
      <div className="header-pages">
        <ul>
            ...
            <li><NavLink className={'hover-underline-animation'} to={`/team`}>Portfolio</NavLink></li>
            <li><NavLink className={'hover-underline-animation'}  to={`/services`}>Services</NavLink></li>
            <li><NavLink className={'hover-underline-animation'} to={`/projects`}>Projects</NavLink></li>
