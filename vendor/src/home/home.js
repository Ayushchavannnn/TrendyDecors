...
import img1 from "../ImagesH/hero1.jpg"
...
export function Home() {
  ...
  return (
    <div className="home">
      {/* <VideoButton/> */}
      <div className="homeNews" style={{ backgroundImage: `url(${img1})`, backgroundPositionY: offset * 0.5 + "px" }}>
        <h1>Let Your Home Be Unique</h1>
        <p>
        From curated collections to trend forecasts, we offer a treasure trove of ideas to ignite your creativity.
        </p>
        <Link to="">
          <button>
            Get Started
            ...
            .map((s, ind) => {
              return (
                <div className="homePlan" key={ind}>
                  <h2 className={'hover-underline-animation'}>{s.service_name}</h2>
                  <p>{` We partner with trusted ${s.service_name} and suppliers to ensure that every aspect of your interior design project meets the highest standards of quality and craftsmanship.`}</p>
              ...
              return (
                <div className="person" key={ind}>
                  <div className="person-title">
                    <div>
                      {/* Aryav Image map se alag alag daal */}
        ...
        <div className="homeProjects">
          ...
          <div className="hp-list">
            ...
            <div className="hp-project">
              ...
              <div className="hp-pro-detail">
                <div className="hp-pro-info">
                  <p className="hp-prj-title">Modern Desktop</p>
                  <p className="hp-prj-path">Decor / Architecture</p>
                </div>
                <div className="hp-pro-btn">
                  <Link to={`/project-details`}>
      ...
      <div className="h-interno">
        <h1>Wanna join the Trendy Decors?</h1>
